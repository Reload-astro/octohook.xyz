...
local library = {
    ...
    signal      = loadstring(game:HttpGetAsync('https://raw.githubusercontent.com/Reload-astro/octohook.xyz/refs/heads/main/Signal.lua'))(),
    stat        = {fps = 0, ping = 0},
    drawings    = {
        active    = {},
        draggable = {},
